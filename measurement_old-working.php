...
foreach ($xml->content->item as $value) { 
	...
	$stmt_2 = $db->prepare("INSERT INTO fingerprints_TestOnly (Room, Position, AP_Mac, Average, Variance, Values_Num, id) VALUES (:room,:coordinates,:mac,:sig,:variance,:numOfValues,:id)");
