...
$user_signals_relations = user_divisions_to_array($user_signals);
...
$allRelations = database_divisions_to_array($fingerPrints);
...
$userComparison = division_distance($allRelations, $user_signals_relations);
